...
export function SiteHeaderActions (props: {
  ...
  return (
    <div className={clsx('h-header w-full gap-0.5 items-center', className)}>
      <ThemeToggle />
      {social?.github && (
        <NextLink href={social.github} target="_blank" className="ml-auto" aria-label="GitHub链接">
      ...
      {social.twitter && (
        <NextLink href={social.twitter} target="_blank" className="" aria-label="Twitter链接">
          <Button size="icon" variant="ghost" className="rounded-full">
            <TwitterXSvg />
          </Button>
        </NextLink>
      ...
      {social.discord && (
        <NextLink href={social.discord} target="_blank" className="" aria-label="Discord链接">
          <Button size="icon" variant="ghost" className="rounded-full">
            <DiscordSvg />
          </Button>
        </NextLink>
