...
class OracleConnector(BaseConnector):
    ...
    def _init_parameters(self) -> None:
        ...
        config = decrypt_dict_values(
            self.connection_config.config, OracleParameters.SENSITIVE_FIELDS
        )
    ...
    def connect(self) -> bool:
        ...
        try:
            ...
            # 更新连接状态
            logger.info(
                f"Successfully connected to Oracle database: {self.parameters.database}"
            )
            return True
    ...
    def execute_query(
        ...
        if self.connection_config.read_only:
            ...
            if not (
                ...
                or query_upper.startswith("BEGIN")
            ):
